    ...
    <body data-spy="scroll" data-target="#navbar-menu" data-offset="100">
            ...
            <div class="side">
                ...
                <div class="widget">
                    ...
                    <li><a href="index.php">home page</a></li>
                        ...
                        <h4><li><a href="bestel.php">bestelformulier</a></li></h4>
                    </ul>
                </div>
            </div>
        ...
        <section id="block">
            <div class="container text-center" style="-webkit-text-stoke: thin; color: darkred; text-transform: uppercase;">
                <div class="row row-cols-1 row-cols-md-3 g-4" style="margin-left: -10px; margin-right: -10px; margin-top: 100px; margin-bottom: 100px;">
            <form action="" method="post">
                <div class="form-outline form-white mb-4">
                    <input type="lastname" id="lastname" name="lastname" class="form-control form-control-lg" value=""/>
                    <label class="form-label" for="typevarcharX">lastname</label>
                  </div>
    
                  <div class="form-outline form-white mb-4">
                    <input type="email" id="email" name="email" class="form-control form-control-lg" value=""/>
                    <label class="form-label" for="typevarcharX">email</label>
                  </div>

                  <div class="form-outline form-white mb-4">
                    <input type="phonenumber" id="phonenumber" name="phonenumber" class="form-control form-control-lg" value=""/>
                    <label class="form-label" for="typevarcharX">phonenumber</label>
                  </div>

                  <div class="form-outline form-white mb-4">
                    <input type="address" id="address" name="address" class="form-control form-control-lg" value=""/>
                    <label class="form-label" for="typevarcharX">address</label>
                  </div>

                  
                  <div class="form-outline form-white mb-4">
                    <div type="totalorder" id="totalorder" name="totalorder" class="form-control form-control-lg" value="" style="height: auto; white-space: pre-line;">
                    ...
                    <label class="form-label" for="typevarcharX">order</label>
                  </div>
